export function collectVisibleItemSignatures(checkboxSelector: string): string[] {
  class VisibleItemSignatureCollector {
  ...
  return new VisibleItemSignatureCollector().collect();
}
